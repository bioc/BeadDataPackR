...
If you make use of \Rpackage{BeadDataPackR} to ease distribution your data please cite the following paper:\\

\noindent BeadDataPackR: A tool to facilitate the sharing of raw data from Illumina BeadArray studies. \textit{Cancer Informatics}. 2010, 9:217-227
